...
class Qwen3_5ForCausalLMBase(
    ...
    # Text-only Qwen3.5 checkpoints can reuse the public multimodal config.
    # Their text positions are identical on all three M-RoPE axes.
    supports_mrope = True
    ...
    def get_mrope_input_positions(
        ...
        if mm_features:
            raise ValueError(
                "Text-only Qwen3.5 does not accept multimodal features."
            )
