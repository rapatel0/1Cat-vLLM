...
class EngineArgs:
    ...
    def _maybe_apply_sm70_mtp_defaults(
        ...
        if (
            spec_method == "mtp"
            and "draft_sample_method" not in self.speculative_config
        ):
            # Native MTP keeps its validated probabilistic default. DFlash
            # retains SpeculativeConfig's established sampling default.
