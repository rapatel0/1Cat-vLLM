...
def test_sm70_explicit_dflash_keeps_sampling_default_unset(monkeypatch):
    args = _apply_sm70_defaults(
        monkeypatch,
...
def test_sm70_explicit_dflash_preserves_sampling_override(monkeypatch):
    args = _apply_sm70_defaults(
        monkeypatch,
        speculative_config={
            "method": "dflash",
    ...
    assert isinstance(args.speculative_config, dict)
